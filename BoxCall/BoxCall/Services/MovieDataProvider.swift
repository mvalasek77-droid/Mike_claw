...
/// Implementations swap trivially between the verified built-in slate,
/// TMDB direct, and the
...
final class VerifiedMovieProvider: MovieDataProvider {
    func fetchUpcoming(windowDays: Int) async throws -> [Movie] {
        ...
        return VerifiedMovieProvider.builtInSeed()
    ...
    static func builtInSeed() -> [Movie] {
        ...
        return [
            ...
            .init(id: "m_verity", title: "Verity",
                  ...
                  consensusOpeningMillions: 32, impliedVolPct: 45,
            ...
            .init(id: "m_violent_night2", title: "Violent Night 2",
                  ...
                  consensusOpeningMillions: 20, impliedVolPct: 46,
                  genre: "Action", addedAt: addedAt,
                  director: "Tommy Wirkola",
                  cast: ["David Harbour", "Kristen Bell", "Daniela Melchior", "Jared Harris"],
            ...
            .init(id: "m_avengers_doomsday", title: "Avengers: Doomsday",
                  ...
                  cast: ["Robert Downey Jr.", "Chris Hemsworth", "Anthony Mackie", "Pedro Pascal"],
                  synopsis: "Doctor Doom against the assembled heroes of the Multiverse Saga. Presales have surpassed $50M with 100+ days to go.",
                  trailerQuery: "Avengers Doomsday official trailer",
                  tradeProjection: TradeProjection(
                      lowMillions: 260, highMillions: 400,
            ...
            .init(id: "m_dune_three", title: "Dune: Part Three",
                  ...
                  cast: ["Timothée Chalamet", "Zendaya", "Robert Pattinson", "Florence Pugh"],
            ...
            .init(id: "m_werwulf", title: "Werwulf",
                  ...
                  cast: ["Aaron Taylor-Johnson", "Willem Dafoe", "Lily-Rose Depp", "Ralph Ineson"],
