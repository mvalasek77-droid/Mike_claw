...
final class BalanceAndCoverageTests: XCTestCase {
    ...
    func testBossSurvivesEveryNonMillionAssault() {
        ...
        for combo in 0...7 {
            var engine = WatchsmashEngine(seed: 5)
        ...
        var jabEngine = WatchsmashEngine(seed: 5)
        ...
        var killEngine = WatchsmashEngine(seed: 5)
    ...
    func testDifficultyRampIsNeutralOnFloorOneAndRisesToTheTop() {
        var floorOne = WatchsmashEngine(seed: 1)
        ...
        var top = WatchsmashEngine(seed: 1)
    ...
    private func damageOutput(at chapter: StoryChapter,
                              ...
                              ticks: Int,
                              seed: UInt64 = 11) -> Int {
        var engine = WatchsmashEngine(seed: seed)
