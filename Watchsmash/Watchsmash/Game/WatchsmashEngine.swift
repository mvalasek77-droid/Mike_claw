...
private enum FightRuleSet: Equatable {
    ...
    var opponentWinsToEnd: Int {
        ...
        // the Pit to fight Abaddon instead (WatchsmashEngine.resolveRoundIfNeeded).
...
struct WatchsmashEngine {
    private(set) var state: WatchsmashState
