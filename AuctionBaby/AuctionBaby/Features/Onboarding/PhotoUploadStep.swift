            ...
            HStack(spacing: 6) {
                if index != 0 {
                    Button { makePrimary(index) } label: {
                        Image(systemName: "star").font(.dynamicScaled(11, weight: .bold, relativeTo: .caption2))
                ...
                Button { remove(at: index) } label: {
                    Image(systemName: "xmark").font(.dynamicScaled(11, weight: .bold, relativeTo: .caption2))
                        .foregroundStyle(.white).padding(6)
                        .background(Circle().fill(.black.opacity(0.55)))
                }
                .buttonStyle(.plain)
