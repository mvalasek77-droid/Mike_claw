...
struct FiltersView: View {
    ...
    private var ageCard: some View {
        GlassCard(title: "Age", icon: "calendar", tint: Theme.gold) {
            ...
            VStack(spacing: 4) {
                HStack { Text("Min").font(.dynamicScaled(11, relativeTo: .caption2)).foregroundStyle(Theme.inkFaint); Spacer() }
                ...
                HStack { Text("Max").font(.dynamicScaled(11, relativeTo: .caption2)).foregroundStyle(Theme.inkFaint); Spacer() }
        ...
        GlassCard(title: "Advanced filters", icon: "slider.horizontal.3", tint: Theme.rose) {
            if !hasReserve {
                Button { showStore = true } label: {
                    ...
                    .font(.dynamicScaled(13, weight: .bold, design: .rounded, relativeTo: .footnote)).foregroundStyle(Theme.rose)
                    .padding(.vertical, 4)
                }.buttonStyle(.plain)
            }
            Toggle(isOn: Binding(
            ...
            VStack(alignment: .leading, spacing: 8) {
                Text("MATCH INTERESTS").font(.dynamicScaled(10, weight: .bold, design: .rounded, relativeTo: .caption2))
        ...
        GlassCard(title: "Reserve Requirements", icon: "checklist", tint: Theme.gold) {
            ...
            if !hasReserve {
                Button { showStore = true } label: {
                    ...
                    .font(.dynamicScaled(13, weight: .bold, design: .rounded, relativeTo: .footnote)).foregroundStyle(Theme.gold)
                    .padding(.vertical, 4)
                }.buttonStyle(.plain)
            }
    ...
    private var heightRow: some View {
        VStack(alignment: .leading, spacing: 6) {
            HStack {
                Text("Minimum height").font(.dynamicScaled(13, weight: .semibold, relativeTo: .footnote))
    ...
    private func enumRow<Option: RawRepresentable & Identifiable & CaseIterable>(
        ...
        HStack {
            Text(title).font(.dynamicScaled(13, weight: .semibold, relativeTo: .footnote)).foregroundStyle(Theme.ink)
            Spacer()
            Menu {
                ...
                HStack(spacing: 4) {
                    Text(binding.wrappedValue?.rawValue ?? "Any")
                        .font(.dynamicScaled(13, weight: .heavy, design: .rounded, relativeTo: .footnote))
                    Image(systemName: "chevron.down").font(.dynamicScaled(9, weight: .bold, relativeTo: .caption2))
                }
                .foregroundStyle(Theme.gold)
