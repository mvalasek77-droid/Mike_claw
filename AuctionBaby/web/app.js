...
(() => {
  ...
  const seedFloor = () => ([
    ...
    W("Rae",27,"SoHo, New York",100,"Gallery girl by day, downtown by night. I know what I want and I don't settle.",[P("The way to win me over is","Be direct, be confident, and make the reservation before you ask.")],180,true,false,false,"photo-harper",["Wine","Art","Travel"],{height:"5'6\"",drinks:"Socially"},620),
    ...
    W("Noor Haddad",26,"Capitol Hill, Seattle",200,"Climate engineer. I'll hike in any weather and I fact-check fun facts — lovingly.",[P("Best travel story","Got weathered-in on a glacier for two days. Still the best trip of my life."),P("I'm weirdly good at","Parallel parking and reading a room.")],151,false,false,false,"photo-noor",["Fitness","Travel","Reading","Music"],{height:"5'6\"",drinks:"Rarely"},550),
    ...
    W("Amber Skye",24,"Malibu",200,"Grew up on this coast and never left. Golden hour is a personality trait, I've accepted it.",[P("Best first date","Tacos on the beach, then see where the night goes.")],25,false,false,false,"photo-amber",["Travel","Fitness","Music"],{height:"5'6\"",drinks:"Socially"},470),
    ...
    W("Lucia Reyes",25,"Ibiza",200,"Summers in Europe, winters wherever the sun is. I collect wine, sunsets, and men who can keep up.",[P("My ideal date","Somewhere with a view and a bottle we'll remember. You pick the place.")],7,false,false,false,"photo-lucia",["Travel","Wine","Nightlife","Art"],{height:"5'6\"",drinks:"Regularly"},490),
    ...
    W("Camille Adler",32,"Gold Coast, Chicago",200,"Wine importer. I've been to more vineyards than restaurants but I still can't say no to a good tasting menu.",[P("Unusual skills","I can blind-taste a Burgundy from a Bordeaux. And I parallel park on the first try.")],43,false,false,false,"photo-camille",["Wine","Travel","Food","Film"],{height:"5'8\"",drinks:"Regularly"},590),
    ...
    W("Nikki West",29,"Newport Beach, CA",200,"Charter broker. Weekdays I sell the boat, weekends I'm on it.",[P("Best first date","Sunset sail. No agenda, no timeline, just the ocean and whatever we're drinking.")],194,false,false,false,"photo-nikki",["Travel","Fitness","Nightlife","Wine"],{height:"5'7\"",drinks:"Regularly"},500),
    ...
    W("Chloe Park",28,"Charleston, South Carolina",200,"Event planner. I turn empty rooms into something people remember.",[P("My simple pleasure","Sweet tea, a good porch, and a dog that greets me at the door.")],79,false,false,false,"photo-chloe",["Design","Food","Reading","Dogs"],{height:"5'5\"",drinks:"Socially"},520),
    ...
    W("Paige Nolan",31,"Calabasas, CA",200,"Wellness brand founder. I built my company poolside and I'm not apologizing for it.",[P("Dating me is like","A five-star retreat — intentional, restorative, and you'll leave better than you came in.")],295,false,false,false,"photo-paige",["Fitness","Startups","Travel","Design"],{height:"5'7\"",drinks:"Rarely"},570),
    ...
    W("Hayley James",30,"Savannah, Georgia",200,"Restaurant owner. Sunday brunch is my religion and Saturday night is my confessional.",[P("The way to win me over is","Sit at the bar, order something interesting, and make me laugh before the food comes.")],72,false,false,false,"photo-hayley",["Food","Wine","Music","Dogs"],{height:"5'6\"",drinks:"Regularly"},540),
    ...
    W("Charlotte Fox",31,"Greenwich, Connecticut",200,"Antiques dealer. I know what things are worth and I don't negotiate on the ones that matter.",[P("Unusual skills","I can date a piece of furniture from across the room and pick the best bottle on any list.")],54,false,false,false,"photo-charlotte",["Art","Wine","Design","Travel"],{height:"5'7\"",drinks:"Regularly"},600),
    ...
    W("Lily Tran",25,"Kitsilano, Vancouver",200,"UX designer who walks everywhere. Cherry blossom season is my Super Bowl.",[P("I geek out on","Typography, city planning, and the way light changes between 5 and 6 PM.")],317,false,false,false,"photo-lily",["Design","Art","Food","Reading"],{height:"5'4\"",drinks:"Socially"},530),
    ...
    W("Stella Cruz",27,"Sayulita, Mexico",200,"Surf photographer. I chase golden hour the way some people chase promotions.",[P("Together we could","Catch the last wave, rinse off, and eat tacos with sandy feet.")],115,false,false,false,"photo-stella",["Art","Travel","Fitness","Music"],{height:"5'5\"",drinks:"Socially"},500),
    ...
    W("Nova Ray",26,"Playa del Carmen, Mexico",200,"Freediver and ocean conservationist. I hold my breath for a living and speak my mind for free.",[P("Unusual skills","Holding my breath for four minutes, finding hidden beaches, and making friends in every country.")],180,false,false,false,"photo-nova",["Travel","Fitness","Reading","Art"],{height:"5'6\"",drinks:"Rarely"},540),
    ...
    W("Wren Bishop",26,"Montauk, New York",200,"Photographer. Sunset is my golden hour and the beach is my studio. I shoot on film and live like it.",[P("My simple pleasure","A cold drink, warm sand, and a conversation that doesn't need a phone.")],101,false,false,false,"photo-wren",["Art","Travel","Film","Music"],{height:"5'6\"",drinks:"Socially"},520),
    ...
    W("Suki Nakamura",26,"Venice Beach, CA",200,"Content strategist who clocks out at 5 and is on the sand by 5:15.",[P("My happy place","Golden hour at the beach, then ramen at the place with no sign.")],238,false,false,false,"photo-suki",["Food","Travel","Fitness","Design"],{height:"5'5\"",drinks:"Socially"},500),
    ...
    W("Simone Hart",28,"Turks and Caicos",200,"Former pro swimmer, current water-sports instructor.",[P("Unusual skills","Swimming in open water, reading people, and making fish tacos from scratch.")],122,false,false,false,"photo-simone",["Fitness","Travel","Food"],{height:"5'9\"",drinks:"Socially"},520),
