    ...
    static func catalog() -> [MediaItem] {
        [
            ...
            MediaItem(
                ...
                type: .music,
                genre: "Country / Blues",
                synopsis: "Stained with Kentucky fire, sugar cane sweetness, and smoke's desire — a whiskey-soaked lullaby where hair like spun gold meets the amber pour. Written by Mike Valasek, produced with Suno.",
                aiTools: ["Suno"],
                commercialScore: 91,
                price: 1.29,
                releaseYear: 2026,
            ...
            MediaItem(
                ...
                type: .music,
                genre: "Hip-Hop / Pop",
                synopsis: "A hook-heavy anthem about unstoppable swagger — sicking that thing, making that thing, and getting in trouble for it. Written by Mike Valasek, produced with Suno.",
                aiTools: ["Suno"],
                commercialScore: 90,
                price: 1.29,
                releaseYear: 2026,
            ...
            MediaItem(
                ...
                synopsis: "Some threads bleed through air, some through Eli Hayes — a dark poetic tapestry of cobweb lace whispers, cracked glass reflections, and gold-painted scars. Written by Mike Valasek, produced with Suno.",
                aiTools: ["Suno"],
                commercialScore: 92,
                price: 1.29,
                releaseYear: 2026,
