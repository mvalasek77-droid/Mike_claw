            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 22) {
                    ...
                    PrimaryButton(title: "Create account", systemImage: "arrow.right",
                        ...
                        if isDemo {
                            // App Review credential path. Typing "demo" as
                            // the publisher / pen name accepts the terms
                            // implicitly, fills demo email + name, and
                            // signs in via the demoMode-aware register.
                            // See DEMO_MODE.md for the exact credentials.
