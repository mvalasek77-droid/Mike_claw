...
private struct TermsBody: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 18) {
            Clause("Summary", "Publish AI-made novels, music and film. Disclose the AI you used. Pass the AI Editor's 85% commercial-quality bar to go live. You keep 85% of net proceeds; AI Marketplace keeps 15%.")
            ...
            Clause("Pricing, fees & royalties", "You set your list price within the allowed range. Of each sale, you keep 85% of net proceeds and AI Marketplace retains a 15% service fee. Payout timing may change with notice.")
