...
private struct TermsBody: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 18) {
            Clause("Summary", "Publish AI-made novels, music and film. Disclose the AI you used. Pass the AI Editor's 85% commercial-quality bar to go live. Sales go through Apple's App Store, which takes its commission first; of the remaining proceeds you keep 85% and AI Marketplace keeps 15%.")
            ...
            Clause("Pricing, fees & royalties", "You set your list price within the allowed range. Purchases are processed through Apple's App Store, which deducts its standard In-App Purchase commission (15–30%) first. Of the remaining proceeds, AI Marketplace retains a 15% service fee and pays you the other 85%. Apple's commission, our fees, and payout timing may change with notice.")
