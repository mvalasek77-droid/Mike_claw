...
enum StageLibrary {
    static let all: [StageSpec] = [
        ...
        StageSpec(id: "runway", name: "THE RUNWAY",
                  ...
                  motif: .city),
        StageSpec(id: "hell", name: "THE PIT",
                  skyTop: RGBA(0.14, 0.01, 0.0), skyBottom: RGBA(0.65, 0.10, 0.02),
                  farColor: RGBA(0.28, 0.04, 0.02), midColor: RGBA(0.42, 0.06, 0.02),
                  groundColor: RGBA(0.16, 0.02, 0.01), accent: RGBA(1.0, 0.5, 0.1),
                  motif: .volcano),
