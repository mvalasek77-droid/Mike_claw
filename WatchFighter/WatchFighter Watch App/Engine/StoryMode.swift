...
enum StoryScript {
    ...
    static let ladder: [StoryBeat] = [
        ...
        StoryBeat(opponentID: "corsair",
                  preFight: "Climb all you like, friend — every tide takes the high ground back. Drink?",
                  postWin: "He laughed the whole match. I almost did too."),
        ...
        StoryBeat(opponentID: "nova",
                  preFight: "Nothing personal. You're just standing between me and a very old contract.",
                  postWin: "She holstered it and nodded. Respect, from a gun for hire."),
        ...
        StoryBeat(opponentID: "onyx",
                  ...
                  postWin: "He stepped aside. 'The last door,' he said, 'was never mine.'"),
        StoryBeat(opponentID: "titus",
                  preFight: "(He says nothing. He just raises his fists. The bell has never rung for him.)",
                  postWin: "The undefeated, defeated. For the first time, the tower is quiet — and the gate is mine to leave open."),
    ]
}
