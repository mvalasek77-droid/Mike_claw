...
pub const DEFAULT_COHERE_BASE_URL: &str = "https://api.cohere.ai/v2";
pub const DEFAULT_OPENROUTER_BASE_URL: &str = "https://openrouter.ai/api/v1";
pub const DEFAULT_TOGETHER_BASE_URL: &str = "https://api.together.ai/v1";
pub const DEFAULT_AI21_BASE_URL: &str = "https://api.ai21.com/v1";
pub const DEFAULT_OLLAMA_BASE_URL: &str = "http://localhost:11434/v1";
pub const DEFAULT_CLOUDFLARE_BASE_URL: &str = "https://api.cloudflare.com/client/v4/ai";
pub const DEFAULT_AWS_BASE_URL: &str = "https://bedrock-runtime.amazonaws.com";
...
const PERPLEXITY_ENV_VARS: &[&str] = &["PERPLEXITY_API_KEY"];
...
const AI21_ENV_VARS: &[&str] = &["AI21_API_KEY"];
const OLLAMA_ENV_VARS: &[&str] = &["OLLAMA_API_KEY"];
const CLOUDFLARE_ENV_VARS: &[&str] = &["CLOUDFLARE_API_KEY"];
const AWS_ENV_VARS: &[&str] = &["AWS_ACCESS_KEY_ID", "AWS_SECRET_ACCESS_KEY"];
...
impl OpenAiCompatConfig {
    ...
    #[must_use]
    pub const fn ai21() -> Self {
        Self {
            provider_name: "AI21",
            api_key_env: "AI21_API_KEY",
            base_url_env: "AI21_BASE_URL",
            default_base_url: DEFAULT_AI21_BASE_URL,
            max_request_body_bytes: OPENAI_MAX_REQUEST_BODY_BYTES,
        }
    }
    ...
    #[must_use]
    pub const fn aws() -> Self {
        Self {
            provider_name: "AWS Bedrock",
            api_key_env: "AWS_ACCESS_KEY_ID",
            base_url_env: "AWS_BASE_URL",
            default_base_url: DEFAULT_AWS_BASE_URL,
            max_request_body_bytes: OPENAI_MAX_REQUEST_BODY_BYTES,
        }
    }
    ...
    pub fn credential_env_vars(self) -> &'static [&'static str] {
        match self.provider_name {
            ...
            "Groq" => GROQ_ENV_VARS,
            "Perplexity" => PERPLEXITY_ENV_VARS,
