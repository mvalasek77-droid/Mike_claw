...
impl ApiError {
    ...
    pub fn is_retryable(&self) -> bool {
        match self {
            ...
            | &ApiError::UnknownProvider(_) => false,
        }
    }
    ...
    pub fn request_id(&self) -> Option<&str> {
        match self {
            ...
            | Self::BackoffOverflow { .. }
            | Self::RequestBodySizeExceeded { .. }
            | &ApiError::UnknownProvider(_) => None,
        }
    }
    ...
    pub fn safe_failure_class(&self) -> &'static str {
        match self {
            ...
            Self::UnknownProvider(_) => "unknown",
        }
    }
    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::RequestBodySizeExceeded {
                ...
                f,
                "request body size ({} bytes) exceeds {} limit ({} bytes); reduce prompt length or context before retrying",
